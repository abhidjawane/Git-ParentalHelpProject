...
<body>
	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form action="doctorforgotPass" method="post">
				...
				<span>or use your email for registration</span> <input
					class="form-control form-control-sm" type="text" name="drUsername"
					placeholder="UserName" pattern="[A-Za-z0-9]{1,15}" required
					autocomplete="off" title="only 15 characters & numbers allowed" />
				<input class="form-control form-control-sm" type="email"
					name="drEmail" placeholder="Email"
					pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z]{5})\.([a-zA-Z]{3})$"
					required autocomplete="off" title="enter valid email" /> <input
					class="form-control form-control-sm" type="password"
					name="drPassword" placeholder="Enter new password"
		...
		<div class="form-container sign-in-container">
			<form action="Authentdrlogin" method="post">
				...
				<span>or use your account</span> <input type="text"
					name="drUsername" placeholder="Username" required="required" /> <input
					type="password" name="drPassword" placeholder="Password"
					required="required" /> <a href="/home"><i class="fas fa-chevron-circle-left fa-2x" ></i></a>
