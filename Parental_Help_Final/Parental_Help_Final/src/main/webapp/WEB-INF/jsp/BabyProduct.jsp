...
<br> <br>  
 ...
 <!-- <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/601.jpg" class="d-block w-100" alt="..." width="1450" height="600">
			...
			<div class="col-4 mt-2">
				<div class="card">
					<img src="images/p7.jpg"
						...
						class="card-img-top">
					<div class="card-body">
						<h5 class="card-title">Baby care Kit</h5>
			...
			<div class="col-4 mt-2">
				<div class="card">
					<img src="images/p14.jpg"
						...
						class="card-img-top">
					<div class="card-body">
						<h5 class="card-title">Huggies Wonder Pants</h5>
			...
			<div class="col-4 mt-2">
				<div class="card">
					<img src="images/p19.jpg"
						...
						class="card-img-top">
					<div class="card-body">
						<h5 class="card-title">Baby Proofing Corner Guards</h5>
