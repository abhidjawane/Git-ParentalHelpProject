		...
		<div class="form-container sign-up-container">
			<form action="forgotPass" method="post">
				...
				<input class="form-control form-control-sm" type="email"
					...
					name="ptPassword" placeholder="Enter new password"
		...
		<div class="form-container sign-in-container">
			<form action="AuthUsrlogin" method="post">
				...
				<span>or use your account</span> <input type="text"
					name="ptUsername" placeholder="Username" required="required" /> <input
					type="password" name="ptPassword" placeholder="Password"
